...
cargo run --package s57tiler --bin s57tiler -- mbtiles -g -i "$(pwd)"/data/charts/US5WA22M/US5WA22M.000 -o "$(pwd)"/data -n LNDARE,DEPARE,DEPCNT,SEAARE,SLCONS,PONTON,HULKES,SOUNDG,BOYSPP,LIGHTS,DSID
